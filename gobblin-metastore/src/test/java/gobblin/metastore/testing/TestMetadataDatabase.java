...
class TestMetadataDatabase implements ITestMetastoreDatabase {
  ...
  TestMetadataDatabase(TestMetastoreDatabaseServer testMetastoreDatabaseServer) throws Exception {
  ...
  public void resetDatabase() throws Exception {
    this.testMetastoreDatabaseServer.prepareDatabase(database);
  }
