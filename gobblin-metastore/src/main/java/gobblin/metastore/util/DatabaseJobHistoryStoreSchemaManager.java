...
public class DatabaseJobHistoryStoreSchemaManager implements Closeable {
  ...
  public interface DataSourceBuilder {
    FinalBuilder setDataSource(String url, String user, String password);
  }
  ...
  private static class Builder implements DataSourceBuilder, FinalBuilder {
    ...
    @Override
    public FinalBuilder setDataSource(String url, String user, String password) {
