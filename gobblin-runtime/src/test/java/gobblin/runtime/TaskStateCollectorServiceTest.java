...
public class TaskStateCollectorServiceTest {
  ...
  private static final String TASK_ID_0 = JobLauncherUtils.newTaskId(JOB_ID, 0).toString();
  private static final String TASK_ID_1 = JobLauncherUtils.newTaskId(JOB_ID, 1).toString();
