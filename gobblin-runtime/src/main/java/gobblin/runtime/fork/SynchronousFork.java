...
public class SynchronousFork extends Fork {
    ...
    public SynchronousFork(TaskContext taskContext, Object schema, int branches, int index) throws Exception {
        super(taskContext, schema, branches, index);
    ...
    protected void processRecords() {
        try {
            ...
            if (this.throwable != null) {
                throw Lombok.sneakyThrow(this.throwable);
            }
